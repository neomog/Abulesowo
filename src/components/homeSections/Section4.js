  ...
  return (
    <div className="section4 mainContainer">
      <section className="row">
        <div className="column" id="none">
          <img src={one} alt="one" />
        </div>

        <div className="column">
          <p>
            How <span className="redText boldText">Abulesowo</span> works
          </p>
          <p>
          ...
          <ol>
            <li className="bullet">
              <span className="bullet-style">01</span>
              <div>
            ...
            <li className="bullet">
              <span className="bullet-style">02</span>
              <div>
            ...
            <li className="bullet">
              <span className="bullet-style">03</span>
              <div>
                <p className="boldText">Pay</p>
                <p>
                  After being satisfied with the Properties you wish to Purchase
                  then You get your official document after payment.
                </p>
              </div>
            </li>
          </ol>
