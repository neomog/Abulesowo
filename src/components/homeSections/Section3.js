      ...
      <section className="thirdSection">
        ...
        <div className="section3-column">
          ...
          <div>
            ...
            <p>
              with over 1 million houses for sale, including houses you won’t
              find anywhere else
            </p>
            <Link to="/consult-us">
          ...
          <div>
            ...
            <p>
              Abulesowo can help you easily find a home apartment for rent that
              you’ii love
            </p>
            <Link to="/rents">
